...
public class UbicacionestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatspersistence.entity.UbicacionestadotipoPK[ idubicacion=" + idubicacion + ", idtipoubicacion=" + idtipoubicacion + ", idestadoubicacion=" + idestadoubicacion + " ]";
    }
