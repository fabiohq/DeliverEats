...
public class FormapagoestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatspersistence.entity.FormapagoestadotipoPK[ idestadoformapago=" + idestadoformapago + ", idtipoformapago=" + idtipoformapago + ", idformapago=" + idformapago + " ]";
    }
