...
public class ActorsistemaestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatspersistence.entity.ActorsistemaestadotipoPK[ idactorsistema=" + idactorsistema + ", idtipoactorsistema=" + idtipoactorsistema + ", idestadoactorsistema=" + idestadoactorsistema + " ]";
    }
