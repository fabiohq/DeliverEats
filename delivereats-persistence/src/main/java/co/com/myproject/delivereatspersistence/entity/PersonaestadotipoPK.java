...
public class PersonaestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatspersistence.entity.PersonaestadotipoPK[ idpersona=" + idpersona + ", idtipopersona=" + idtipopersona + ", idestadopersona=" + idestadopersona + " ]";
    }
