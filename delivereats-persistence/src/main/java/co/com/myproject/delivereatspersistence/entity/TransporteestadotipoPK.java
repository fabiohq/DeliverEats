...
public class TransporteestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatspersistence.entity.TransporteestadotipoPK[ idtransporte=" + idtransporte + ", idtipotransporte=" + idtipotransporte + ", idestadotransporte=" + idestadotransporte + " ]";
    }
