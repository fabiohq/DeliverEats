...
public class CredencialesestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatspersistence.entity.CredencialesestadotipoPK[ idcredenciales=" + idcredenciales + ", idestadocredenciales=" + idestadocredenciales + ", idtipocredenciales=" + idtipocredenciales + " ]";
    }
