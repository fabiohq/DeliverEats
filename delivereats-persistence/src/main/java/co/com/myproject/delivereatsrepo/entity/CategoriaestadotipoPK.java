...
public class CategoriaestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatsrepo.entity.CategoriaestadotipoPK[ idestadocategoria=" + idestadocategoria + ", idtipocategoria=" + idtipocategoria + ", idcategoria=" + idcategoria + " ]";
    }
