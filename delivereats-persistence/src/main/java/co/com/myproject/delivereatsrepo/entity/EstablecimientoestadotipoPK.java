...
public class EstablecimientoestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatsrepo.entity.EstablecimientoestadotipoPK[ idestablecimiento=" + idestablecimiento + ", idestadoestablecimiento=" + idestadoestablecimiento + ", idtipoestadoestablecimiento=" + idtipoestadoestablecimiento + ", idespecialidad=" + idespecialidad + " ]";
    }
