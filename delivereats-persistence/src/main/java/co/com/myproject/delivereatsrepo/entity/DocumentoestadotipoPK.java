...
public class DocumentoestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatsrepo.entity.DocumentoestadotipoPK[ iddocumento=" + iddocumento + ", idtipodocumento=" + idtipodocumento + ", idestadodocumento=" + idestadodocumento + " ]";
    }
