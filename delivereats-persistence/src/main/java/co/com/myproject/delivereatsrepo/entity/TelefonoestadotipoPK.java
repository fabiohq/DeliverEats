...
public class TelefonoestadotipoPK implements Serializable {
    ...
    public String toString() {
        return "co.com.myproject.delivereatsrepo.entity.TelefonoestadotipoPK[ idtelefono=" + idtelefono + ", idtipotelefono=" + idtipotelefono + ", idestadotelefono=" + idestadotelefono + " ]";
    }
